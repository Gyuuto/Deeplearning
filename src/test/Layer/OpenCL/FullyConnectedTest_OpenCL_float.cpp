...
namespace {
    ...
    protected:
        ...
        virtual void SetUp () {
            ...
            layer = std::shared_ptr<Layer<clMatrix, Real>>(new FullyConnected<clMatrix, Real>(1, 2, 1, 3, f, false));
            
            std::vector<clMatrix<Real>> W;
    ...
    protected:
        ...
        virtual void SetUp () {
            f = std::shared_ptr<Function<Real>>(new ReLU<Real>());
            layer = std::shared_ptr<Layer<clMatrix, Real>>(new FullyConnected<clMatrix, Real>(1, 2, 1, 3, f, true));
    ...
    protected:
        ...
        virtual void SetUp () {
            f = std::shared_ptr<Function<Real>>(new ReLU<Real>());
            layer = std::shared_ptr<Layer<clMatrix, Real>>(new FullyConnected<clMatrix, Real>(1, 2, 2, 3, f, false));
    ...
    protected:
        ...
        virtual void SetUp () {
            f = std::shared_ptr<Function<Real>>(new ReLU<Real>());
            layer = std::shared_ptr<Layer<clMatrix, Real>>(new FullyConnected<clMatrix, Real>(1, 2, 2, 3, f, true));
