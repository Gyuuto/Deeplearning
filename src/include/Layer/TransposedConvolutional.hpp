...
{
	this->layer_name = "TransposedConvolutional";
...
template<template<typename> class Mat, typename Real>
void TransposedConvolutional<Mat, Real>::calc_gradient ( const Matrix<Real>& U_apply, const Matrix<Real>& U_diff, const Matrix<Real>& delta, std::vector<Matrix<Real>>& nabla_W, std::vector<Matrix<Real>>& nabla_b )
{
...
#ifdef USE_GPU
template<template<typename> class Mat, typename Real>
void TransposedConvolutional<Mat, Real>::calc_gradient ( const clMatrix<Real>& U_apply, const clMatrix<Real>& U_diff, const clMatrix<Real>& delta, std::vector<clMatrix<Real>>& nabla_W, std::vector<clMatrix<Real>>& nabla_b )
{
	auto tot_beg = std::chrono::system_clock::now();
	auto beg = tot_beg;
...
template<template<typename> class Mat, typename Real>
void TransposedConvolutional<Mat, Real>::calc_delta ( const Matrix<Real>& U_apply, const Matrix<Real>& U_diff, const Matrix<Real>& delta, Matrix<Real>& nx_delta )
{
	auto tot_beg = std::chrono::system_clock::now();
	auto beg = tot_beg;
...
#ifdef USE_GPU
template<template<typename> class Mat, typename Real>
void TransposedConvolutional<Mat, Real>::calc_delta ( const clMatrix<Real>& U_apply, const clMatrix<Real>& U_diff, const clMatrix<Real>& delta, clMatrix<Real>& nx_delta )
{
	auto tot_beg = std::chrono::system_clock::now();
	auto beg = tot_beg;
...
template<template<typename> class Mat, typename Real>
void TransposedConvolutional<Mat, Real>::apply ( const Matrix<Real>& U, Matrix<Real>& ret, bool use_func )
{
	auto tot_beg = std::chrono::system_clock::now();
	auto beg = tot_beg;
...
template<template<typename> class Mat, typename Real>
void TransposedConvolutional<Mat, Real>::apply ( const clMatrix<Real>& U, clMatrix<Real>& ret, bool use_func )
{
	auto tot_beg = std::chrono::system_clock::now();
	auto beg = tot_beg;
